...
│   └── Review/
│       └── .gitkeep
├── Inputs/                   # Place your paper PDFs or images here
│   └── .gitkeep
...
- **Visual Model Quota**: The free Zhipu GLM-4V-Flash model has usage limits. If you exceed them, consider upgrading or switching to another visual model.
